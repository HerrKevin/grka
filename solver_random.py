...
def add_parser_args(parser):
    parser.add_argument('--batch_size', type=int, default=1000, help='Number of random solutions to evaluate in each iteration. Does not actually change anything other than the algorithm speed.')
