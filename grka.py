...
def main():
    ...
    parser.add_argument('problem', choices=['roro', 'func', 'dap', 'rcpsp'], help='Problem type to solve')
    parser.add_argument('solver', choices=['de', 'brkga', 'pso', 'hcpso', 'cmaes', 'ds', 'random'], help='Solver to use to solve the problem')
